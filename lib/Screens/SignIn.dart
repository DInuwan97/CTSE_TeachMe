...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _entryFieldEmail(String title, bool isPassword) {
    return Container(
  ...
  Widget _entryFieldPassword(String title, bool isPassword) {
    return Container(
      margin: EdgeInsets.symmetric(vertical: 10),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        _entryFieldEmail("Email", false),
        _entryFieldPassword("Password", true),
      ],
    );
  }
